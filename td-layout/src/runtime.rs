...
|                  ACPI                  |   (0x100000) 1 MB
+----------------------------------------+ <- 0x7DDDE000
|                  FREE                  |   (0x7B57D000) 1.93 GB
+----------------------------------------+ <- 0x2861000
|                 KERNEL                 |   (0x2000000) 32 MB
+----------------------------------------+ <- 0x861000
|            KERNEL_PARAMETER            |   (0x1000) 4 KB
+----------------------------------------+ <- 0x860000
...
+----------------------------------------+ <- 0x0
Total Usage: 0x4A83000 (74.51 MB)
*/
...
pub const KERNEL_PARAMETER_BASE: usize = 0x860000;
pub const KERNEL_PARAMETER_SIZE: usize = 0x1000; // 4 KB
pub const KERNEL_BASE: usize = 0x861000;
pub const KERNEL_SIZE: usize = 0x2000000; // 32 MB
...
pub const MEMORY_LAYOUT_CONFIG: &[(&'static str, usize, &'static str)] = &[
    ...
    ("KernelParameter", 0x1000, "Memory"),
    ("Kernel", 0x2000000, "Memory"),
    ("Acpi", 0x100000, "Acpi"),
