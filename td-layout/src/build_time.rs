...
pub const TD_SHIM_SEC_CORE_INFO_OFFSET: u32 = 0xFFFFD4; // TD_SHIM_SEC_INFO_OFFSE
...
pub const TD_SHIM_SEC_CORE_INFO_BASE: u32 = 0xFFFFFFD4; // 0xFFFFFFFF - TD_SHIM_SEC_INFO_OFFSET + 1
